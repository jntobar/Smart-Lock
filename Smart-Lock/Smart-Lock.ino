...
const char* ssid = "John's";  //WiFi Name
const char* password = "telematica";  //WiFi Password

// Use @myidbot to find out the chat ID of an individual or a group
// You need to click "start" on a bot before it can message you 
// Initialize Telegram BOT
String chatId = "1858774984";
String BOTtoken = "6359371005:AAEjL_ed8-l7LCtVQCW0vWGGYyHLQabP0xc";
